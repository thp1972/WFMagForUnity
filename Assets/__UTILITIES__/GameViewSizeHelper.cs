...
// https://github.com/Syy9/GameViewSizeChanger/tree/master/GameViewSizeTool
namespace Kyusyukeigo.Helper
{
    public class GameViewSizeHelper
    {
        ...
        // Added by me 
        public static void ChangeGameViewScale(float scale)
        {
            Type gameViewType = Types.gameView;
            EditorWindow gameViewWindow = EditorWindow.GetWindow(Types.gameView);
